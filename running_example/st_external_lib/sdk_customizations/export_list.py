...
import re
from experiment_engine.file_storage_handler import parallel_get_files_on_local_storage
        ...
        for key, event in images_list[video].items():
            ...
            for frame in event['frames']:
                ...
                for key,value in image_paths.items():
                    ...
                    files_dest.append(os.path.join(dst_folder,f'frame-{current_sample[DataFrameTokens.LABELS_GROUP_KEY]}_{key}.png'))
